...
setwd("~/Desktop/Acute_Lymphoid_Leukemia_Project/data/Datasets/Post_manipulation")
...
Control <- read.csv('Controls_merged.csv', sep = ',', header = TRUE)
...
batch_tumor <- c(rep(1, 38), rep(2, 173), rep(3, 321), rep(4, 108),rep(5,377))
batch_control <- c(rep(1, 10), rep(2, 20))
